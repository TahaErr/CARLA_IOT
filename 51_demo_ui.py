...
VIEWPORT_W = 1920
VIEWPORT_H = 1040          # leaves room for taskbar
LEFT_COL_W = 480
RIGHT_COL_W = VIEWPORT_W - LEFT_COL_W
TOP_ROW_H = VIEWPORT_H // 2
BOTTOM_ROW_H = VIEWPORT_H - TOP_ROW_H
...
def build_ui(controller: SimController, args):
    ...
    # --- Config window (top-left) -----------------------------------------
    with dpg.window(label="Configuration", tag="config_window",
                     pos=(0, 0), width=LEFT_COL_W, height=TOP_ROW_H,
    ...
    with dpg.window(label="CARLA Bird's-eye View", tag="bird_window",
                     pos=(LEFT_COL_W, 0), width=RIGHT_COL_W, height=TOP_ROW_H,
                     no_close=True, no_collapse=True, no_resize=True,
                     no_move=True):
    ...
    with dpg.window(label="Live Statistics", tag="stats_window",
                     pos=(0, TOP_ROW_H), width=LEFT_COL_W, height=BOTTOM_ROW_H,
                     no_close=True, no_collapse=True, no_resize=True,
                     no_move=True):
    ...
    with dpg.window(label="RSU Cameras (YOLO + per-RSU stats)",
                     tag="rsu_window",
                     pos=(LEFT_COL_W, TOP_ROW_H), width=RIGHT_COL_W,
                     height=BOTTOM_ROW_H,
                     no_close=True, no_collapse=True, no_resize=True,
                     no_move=True):
